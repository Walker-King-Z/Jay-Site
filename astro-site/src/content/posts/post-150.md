...
categories: ["搞机技巧"]
tags: ["U盘改图标"]
description: "一个更改 U 盘图标的方法"
wordpressId: 150
---
## 事先声明！

但是这个方法可能会导致有些杀毒软件报不安全，因为杀毒软件的默认逻辑是 **“不允许 U 盘携带自动运行脚本接入设备“** ，但是这个方法是 用了一个“脚本“（其实脚本里只是指明了图标文件而已，但归根还是个“脚本“），有概率会被定义为不安全的行为
...
![步骤二 <4>.png](/images/2022/05/839ec3a4.png)
